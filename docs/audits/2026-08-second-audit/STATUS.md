...
- **Adams County property returns empty, every time.** The single Adams parcel
  ...
  **CLOSED as code, 2026-08-27 (`eee8a9e`) — the coverage gate is built,
  committed, not deployed.** `CountyAdapter.covers(city)` defaults to True
