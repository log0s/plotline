...
1. **Imagery normalization** (`docs/adr/0001-imagery-normalization.md`) —
   ...
   **2026-08-28: step 1 is DONE, in production. The ADR is Accepted.**
   ...
   505 unenriched rows and migration 0016 is not deployed**, so the next
   actions in order are: deploy 0016, run the enrichment pass against
   production, then step 2.
