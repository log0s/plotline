...
Started 2026-08-28T21:21:14+00:00. Queue at start: **505** rows with `provenance = 'mosaic_url'`.
...
| id-corrected (found by search under another id) | 303 |
| merged into an existing scenes row | 0 |
| unmatched (left in the queue) | 0 |
| error | 6 |

Rows enriched in place: **499**. Queue after this run: **6**.
...
| `pa_m_4007563_ne_18_1_20130605` | error | item GET 404; HTTPStatusError: Client error '403 Forbidden' for url 'https://planetarycomputer.microsoft.com/api/stac/v1/search'
...
| `pa_m_4007563_se_18_1_20170612` | error | item GET 404; HTTPStatusError: Client error '403 Forbidden' for url 'https://planetarycomputer.microsoft.com/api/stac/v1/search'
For more information check: https://developer.mozilla.org/en-US/docs/Web/HTTP/Status/403 |
...
| `sc_m_3508254_ne_17_1_20110430` | error | item GET 404; HTTPStatusError: Client error '403 Forbidden' for url 'https://planetarycomputer.microsoft.com/api/stac/v1/search'
For more information check: https://developer.mozilla.org/en-US/docs/Web/HTTP/Status/403 |
| `sc_m_3508254_ne_17_1_20131005` | id-corrected | item GET 404; found by search as sc_m_3508254_ne_17_1_20131005_20131106 |
| `sc_m_3508254_ne_17_1_20150424` | error | item GET 404; HTTPStatusError: Client error '403 Forbidden' for url 'https://planetarycomputer.microsoft.com/api/stac/v1/search'
For more information check: https://developer.mozilla.org/en-US/docs/Web/HTTP/Status/403 |
| `sc_m_3508254_ne_17_1_20170730` | id-corrected | item GET 404; found by search as sc_m_3508254_ne_17_1_20170730_20171207 |
| `tn_m_3508959_se_16_060_20180804` | error | item GET 404; HTTPStatusError: Client error '403 Forbidden' for url 'https://planetarycomputer.microsoft.com/api/stac/v1/search'
For more information check: https://developer.mozilla.org/en-US/docs/Web/HTTP/Status/403 |
...
| `tx_m_3009743_nw_14_1_20141014` | error | item GET 404; HTTPStatusError: Client error '403 Forbidden' for url 'https://planetarycomputer.microsoft.com/api/stac/v1/search'
For more information check: https://developer.mozilla.org/en-US/docs/Web/HTTP/Status/403 |
